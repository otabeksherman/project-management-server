...
public class UserService implements UserDetailsService {
     ...
     * @throws UserNotFoundException if the given email does not exist in the users table
     */
    public Map<NotificationType, Boolean> getUserNotificationTypeNotification(String email) throws UserNotFoundException {
        if (userRepository.findUserByEmail(email) == null) {
            throw new UserNotFoundException(String.format("Email %s is not exists in users table", email));
        } else {
            User user = userRepository.findUserByEmail(email);
     ...
     */
    public User updateNotificationTypeSettings(String email, String notificationTypeStr, Boolean update) throws UserNotFoundException, IllegalArgumentException {
        User user;
        if (userRepository.findUserByEmail(email) == null) {
            throw new UserNotFoundException(String.format("Email %s is not exists in users table", email));
        } else {
